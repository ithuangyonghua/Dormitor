	...
	<form id="add-form" method="post">
        <table>
            <tr>
               ...
               <tr>
                <td width="60" align="right">职工号:</td>
                <td><input type="text" id="add-id" name="id" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写用户名'" />
                <input type="hidden" id="add-photo" name="photo" value="/BaseProjectSSM/resources/admin/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
           <!--  <tr>
                <td width="60" align="right">头像:</td>
                <td><input type="hidden" id="add-photo" name="photo" value="/BaseProjectSSM/resources/admin/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text " /></td>
            </tr> -->
            <tr>
                <td width="60" align="right">姓名:</td>
                <td><input type="text" id="add-name" name="username" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写用户名'" /></td>
            </tr>
            <tr>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'id',title:'职工号',width:100,sortable:true},
