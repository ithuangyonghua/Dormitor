...
<!--   <script type="text/javascript" src="../../resources/admin/login/js/jquery-1.8.0.min.js"></script> -->
<body>
...
<div id="particles-js">
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				...
				<div class="login-center-input com-sel">
					<!-- <input type="text" name="role" id="role" value="" placeholder="请输入您的用户名" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;请输入您的用户名&#39;"> -->
				      <select class="com-opt">
				            <option value="-1">选择角色</option>
				            <!-- <option value="1">超级管理员</option> -->
				            <option value="1">管理员</option>
				            <option value="2">宿管老师</option>
...
<script type="text/javascript">
	...
	function changeCpacha(){
		...
		document.querySelector(".login-button").onclick = function(){
				...
				$.ajax({
					url:'login',
					data:{username:username,password:password,cpacha:cpacha,selected:selected},
					type:'post',
					dataType:'json',
					success:function(data){
