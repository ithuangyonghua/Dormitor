...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            <tr>
	    			<td>财产分类名称:</td>
	    			<td><input type="text" name="cname"  id ="add-cname"  maxlength="30" required="true" missingMessage="财产分类名称必须填写"></input></td>
	    		</tr>
	    		<tr>
	    			<td>使用年限:</td>
	    			<td><input type="text" name="cyear"  id ="add-cyear"  maxlength="30" required="true" missingMessage="使用年限必须填写"></input></td>
	    		</tr>
           </table>
    </form>
</div>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
	    		<tr>
	    			<td>财产分类名称:</td>
	    			<td><input type="text" name="cname"  id ="edit-cname"  maxlength="30" required="true" missingMessage="财产分类名称必须填写"></input></td>
	    		</tr>
	    		<tr>
	    			<td>使用年限:</td>
	    			<td><input type="text" name="cyear"  id ="edit-cyear"  maxlength="30" required="true" missingMessage="使用年限必须填写"></input></td>
	    		</tr>
        </table>
        </table>
    </form>
	...
	$(function(){
		$('#add-bedchamberid').combobox({
	       	  onSelect:function(){
	       		  $('#add-uses').combobox({
		                    disabled:false,
		                    url:'../teach/getbstuall/'+$('#add-bedchamberid').combobox("getValue"),
	     ...
	     $('#edit-bedchamberid').combobox({
		       	  onSelect:function(){
		       		  $('#edit-uses').combobox({
			                    disabled:false,
			                    url:'../teach/getbstuall/'+$('#edit-bedchamberid').combobox("getValue"),
			                    editable:false, //不可编辑状态
			    			    cache: false,
			                    valueField:'stuid',//id
			                    textField:'stuname',//power 
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'cyear',title:'使用年限',width:100,sortable:true},
		]],
