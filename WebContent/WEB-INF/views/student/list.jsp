        ...
        <table>
            ...
            <tr>
             ...
             <tr>
                ...
                <td><input type="text" id="add-id" name="id" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写用户名'" />
            ...
            <tr>
              ...
              <tr>
	    			<td width="60" align="right">宿舍:</td>
	    			<td>
	    				<input   name="dormitoryId" style="width:268px" id ="add-dormitoryId" class="easyui-combobox" data-options="valueField:'dormitoryid',textField:'dormitoryname',url:'../teach/dorgetall',prompt:'请选择宿舍,required:true,editable:false'"/>
					</td>
	    	  </tr>
        </table>
    </form>
	...
	<form id="edit-form" method="post">
        ...
        <table>
           ...
           <!--  <tr>
            ...
            <tr>
                <td width="60" align="right">姓名:</td>
                <td><input type="text" id="edit-username" name="username" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写用户名'" />
                 <input type="hidden" id="edit-photo" name="photo" value="/BaseProjectSSM/resources/admin/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text " /></td>
                </td>
            </tr>
            <tr>
                <td width="60" align="right">性别:</td>
            ...
            <tr>
	    			<td width="60" align="right">宿舍:</td>
	    			<td>
	    				<input  style="width:268px" name="dormitoryId"  id ="edit-dormitoryId" class="easyui-combobox" data-options="valueField:'dormitoryid',textField:'dormitoryname',url:'../teach/dorgetall',prompt:'请选择宿舍,required:true,editable:false'"/>
					</td>
	    	</tr>
        </table>
    </form>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'id',title:'学号',width:100,sortable:true},
			...
			{ field:'name',title:'宿舍',width:100,formatter:function(value,row,index){
				if(value==null){
					 return "还未分配宿舍";
				}
				return value;
