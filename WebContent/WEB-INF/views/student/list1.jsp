...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
           ...
           <!-- <tr>
                <td width="60" align="right">寝室:</td>
                <td><input  id="edit-name" name="name" class="easyui-combobox" data-options="valueField:'tid',textField:'name',url:'../dormitory/getall',prompt:'请选择寝室,required:true,editable:false'" /></td>
            </tr>  -->
        </table>
    </form>
</div>
