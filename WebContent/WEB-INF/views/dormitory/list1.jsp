...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>楼栋名称：</label><input id="search-name" class="wu-text" style="width:100px">
...
<script type="text/javascript">
	...
	*/
	$('#data-datagrid').treegrid({
		...
		fit:true,
		columns:[[
			{ field:'name',title:'楼栋名称',width:100,sortable:true},
			{ field:'username',title:'宿管老师',width:100,sortable:true},
